  ...
  d3.csv("data.csv", function(err, data) {
    ...
    data.forEach(row => {
      ...
      row.calendardate = +row.calendardate;
});
    ...
    var currentAxisLabelX = "calendardate";
    var currentAxisLabelY = "price";
    ...
    var toolTip = d3
        ...
        .offset([80, -60])
        .html(function(data) {
          if(currentAxisLabelX === "calendardate")
            return currentAxisLabelY + " : " + data[currentAxisLabelY] + "% <br>" + currentAxisLabelX + " : " + data[currentAxisLabelX] + "%"
          else
            return currentAxisLabelY + " : " + data[currentAxisLabelY] + "% <br>" + currentAxisLabelX + " : $" + data[currentAxisLabelX]
        });
    ...
    chart.call(toolTip);
      ...
      .attr("data-axis-name", "calendardate")
      .text("Date");
